...
func (b *BlockGen) OffsetTime(seconds int64) {
	...
	b.header.Difficulty = CalcDifficulty(MakeChainConfig(), b.header.Time.Uint64(), b.parent.Time().Uint64(), b.parent.Difficulty())
}
...
func makeHeader(parent *types.Block, state *state.StateDB) *types.Header {
	...
	return &types.Header{
		...
		Difficulty: CalcDifficulty(MakeChainConfig(), time.Uint64(), new(big.Int).Sub(time, big.NewInt(10)).Uint64(),  parent.Difficulty()),
